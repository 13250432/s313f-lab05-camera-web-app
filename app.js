...
const cameraView = docuement.querySelector("#camera-view");
...
const frontCameraButton = document.querySelector("#front-camera-button");
...
// If Front/Back camera is clicked => Change to front/back camera accordingly
